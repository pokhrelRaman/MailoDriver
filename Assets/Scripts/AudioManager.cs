...
using Random = UnityEngine.Random;
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        public AudioClip gearShiftClip ;                                            // katti comment lekhnu alxi lagyo 
        ...
        float engineRPM, vertical_UserInput, maxSpeed = 1;
    ...
    void FixedUpdate()
    {
        ...
        void AudioManagement()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, engineRPM / maxSpeed);
                ...
                // get values for fading the sounds based on the acceleration
                    accFade = Mathf.Abs((vertical_UserInput > 0  /*&& !m_CarController.test*/ ) ?vertical_UserInput : 0);
        ...
        // //////////////////////////////////////////////////////Getters 
       /* public void getMaxSpeed(float m_maxSpeed) 
        {
            maxSpeed = m_maxSpeed;
        }*/
        ...
        {
            StopSound();
            SetUpEngineAudioSource(gearShiftClip , false);
            StartSound();
        ...
        public void setEngineRPM(float m_engineRPM , float m_maxSpeed = 120)
        {
            engineRPM = m_engineRPM;
            maxSpeed = m_maxSpeed;
        }

        public void set_vertical_UserInput(float m_vertical_UserInput)
        {
            vertical_UserInput = m_vertical_UserInput;
        }

        private void SetUpEngineAudioSource(AudioClip clip , bool lp )
        {
            // create the new audio source component on the game object and set up its properties
            AudioSource source = gameObject.AddComponent<AudioSource>();
            source.clip = clip;
